	...
	const attemptConnection = useCallback(
		async (retryAttempt = 0) => {
			try {
				...
				console.error(
					`Connection attempt ${retryAttempt + 1} failed:`,
					error
				);
	...
	const renderRoomsTable = () => {
		...
		return (
			<StyledTable>
				<StyledTableHead>
					<StyledTableRow>
						<StyledTableHeader width="45%">
							채팅방
						</StyledTableHeader>
						<StyledTableHeader width="15%">
							참여자
						</StyledTableHeader>
						<StyledTableHeader width="25%">
							생성일
						</StyledTableHeader>
		...
		<div className="auth-container">
			...
			>
				...
				<ModalFooter>
					...
					<Button
						variant="ghost"
						onClick={() => joinRoom(currentModalRoomId, password)}
					>
						확인
					</Button>
				</ModalFooter>
				...
				<Card.Body className="card-body">
					<Stack gap="300" align="center">
						...
						<HStack gap="200">
							<Badge
								color={
									STATUS_CONFIG[connectionStatus].color ===
									"success"
										? "success"
